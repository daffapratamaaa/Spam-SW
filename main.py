...
def banner():
    ...
    autoketik (f"""
     ...
     \033[1;0m──────────────────────────┬─────────────────────────
  \033[1;0m┌────────────────────────────┼───────────────────────────┐
  {W}│ Creator{R}:{W}Daffa Pratama Nur Ardiansyah            │ Version {R}:{G} 3.0{W}             │
  {W}| Addition{R}:{W}Daffa Pratama        |                        {W}   |
  {W}│ Website{R}:{G}www.daffaa.my.id    {W}│ {W}Your Ip {R}:{Y} {ip}      {W}│
  {W}│ Instagram{R}:{W} {biru} daffapratamanurardiansyah         {W}│ Perfect Brutal {biru}Sms Tools  {W}│
  └────────────────────────────┼───────────────────────────┘""")
...
def start(): # Def Untuk Start Tools
    ...
    if pil == "2":
        ...
        tanya()
    if pil == "3":
        os.system("xdg-open https://www.daffaa.my.id")
